...
var OperationsViewModel = function () {
    ...
    self.mth_days = 0;
    self.year_days = 0;
    self.year_days_worked = 0;
    self.years_worked = 0.00;
    self.periods_worked = 0;
    self.periods_worked_to_date = 0;
    self.varcat = ko.observable(0);
    self.scale_amount = 0.00;
    self.c_off_days = 0;
    self.c_off = ko.observable(0);
    self.prorate = 0.00;
    self.h_hid = 0;
    self.loanInterest = 0.00;
    self.loanPrincipal = 0.00;
    self.loanRecovery = 0.00;
    self.loanBalance = 0.00;
